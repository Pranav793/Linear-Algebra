...
class Line(object):
    ...
    def is_line_parallel_to(self, line):
    ...
    def __eq__(self, line):
    	...
    	if not self.is_line_parallel_to(line):
    		return False
    ...
    def intersection(self, line):
    	if self == line:
    		print("Infinite solutions as lines are equal.")
    		return self
    	elif self.is_line_parallel_to(line):
    		print("No solutions as lines are parallel but not equal.")
    		return None
    	else:
...
# print(line1.is_line_parallel_to(line2))
# print(line1 == line2)
